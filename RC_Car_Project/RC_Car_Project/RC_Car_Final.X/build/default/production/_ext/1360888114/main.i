...
# 1 "../APP/../SERVICES/BIT_MATH.h" 1
# 8 "../APP/../SERVICES/config.h" 2
# 725 "../APP/main.c" 2
...
# 727 "../APP/main.c" 2
# 1 "../APP/../HAL/LCD/LCD.h" 1
# 39 "../APP/../HAL/LCD/LCD.h"
void LCD_Init(void);
void LCD_Clear(void);
...
# 728 "../APP/main.c" 2
# 1 "../APP/../HAL/HC-SR04/SR04.h" 1
# 24 "../APP/../HAL/HC-SR04/SR04.h"
void SR04_Init(void);
u16 SR04_GetDistance(u8 sensor_id);
# 729 "../APP/main.c" 2
# 1 "../APP/../HAL/Motor/Motor_interface.h" 1
# 23 "../APP/../HAL/Motor/Motor_interface.h"
...
void main(void)
{
    ...
    while (1)
    {
        ...
        if (PORTAbits.RA0 == 1) current_state = STATE_DOOR_OPEN;
        else if (PORTAbits.RA1 == 0) current_state = STATE_NO_BELT;
        ...
        {
            f = SR04_GetDistance(0); _delay((unsigned long)((10)*(20000000UL/4000.0)));
            l = SR04_GetDistance(1); _delay((unsigned long)((10)*(20000000UL/4000.0)));
            r = SR04_GetDistance(2); _delay((unsigned long)((10)*(20000000UL/4000.0)));
            ...
            else
            {
                ...
                {
                    Motor_Reverse();
                    _delay((unsigned long)((600)*(20000000UL/4000.0)));
                    Motor_Turn_Right();
                    _delay((unsigned long)((600)*(20000000UL/4000.0)));
                    Motor_Stop();
                }
