...
# 2 "<built-in>" 2
# 1 "../MCAL/PWM/PWM_interface.c" 2
# 16 "../MCAL/PWM/PWM_interface.c"
...
# 17 "../MCAL/PWM/PWM_interface.c" 2
# 1 "../MCAL/PWM/PWM_interface.h" 1
# 21 "../MCAL/PWM/PWM_interface.h"
# 1 "../MCAL/PWM/../../SERVICES/STD_TYPES.h" 1
...
# 18 "../MCAL/PWM/PWM_interface.c" 2
# 1 "../MCAL/PWM/../../SERVICES/config.h" 1
...
# 1 "../MCAL/PWM/../../SERVICES/BIT_MATH.h" 1
# 8 "../MCAL/PWM/../../SERVICES/config.h" 2
# 19 "../MCAL/PWM/PWM_interface.c" 2




static volatile u16 g_pulse_ticks = 938U;
static volatile u8 g_state = 0U;
static volatile u8 g_suspended = 0U;
...
void PWM_voidServoISR(void)
{
    ...
    else
    {
        PORTCbits.RC2 = 0;
        g_state = 0U;
        u16 off_ticks = 12500U - g_pulse_ticks;
