...
# 2 "<built-in>" 2
# 1 "../HAL/HC-SR04/SR04.c" 2
# 1 "../HAL/HC-SR04/SR04.h" 1
# 16 "../HAL/HC-SR04/SR04.h"
# 1 "../HAL/HC-SR04/../../SERVICES/STD_TYPES.h" 1
...
# 2 "../HAL/HC-SR04/SR04.c" 2
# 1 "../HAL/HC-SR04/../../SERVICES/config.h" 1
...
# 7 "../HAL/HC-SR04/../../SERVICES/config.h" 2
# 1 "../HAL/HC-SR04/../../SERVICES/BIT_MATH.h" 1
# 8 "../HAL/HC-SR04/../../SERVICES/config.h" 2
# 3 "../HAL/HC-SR04/SR04.c" 2
...
void SR04_Init(void) {
    ...
    TRISDbits.TRISD0 = 0; PORTDbits.RD0 = 0;
    TRISDbits.TRISD1 = 1;
...
u16 SR04_GetDistance(u8 sensor_id) {
    ...
    if (sensor_id == 0) { PORTDbits.RD0 = 1; _delay((unsigned long)((10)*(20000000UL/4000000.0))); PORTDbits.RD0 = 0; }
    else if (sensor_id == 1) { PORTBbits.RB1 = 1; _delay((unsigned long)((10)*(20000000UL/4000000.0))); PORTBbits.RB1 = 0; }
    else if (sensor_id == 2) { PORTBbits.RB3 = 1; _delay((unsigned long)((10)*(20000000UL/4000000.0))); PORTBbits.RB3 = 0; }
    else return 999U;

    while(timeout < 500) {
        if (sensor_id == 0 && PORTDbits.RD1) break;
        if (sensor_id == 1 && PORTBbits.RB2) break;
        if (sensor_id == 2 && PORTBbits.RB4) break;
        _delay((unsigned long)((10)*(20000000UL/4000000.0)));
        timeout++;
    }
