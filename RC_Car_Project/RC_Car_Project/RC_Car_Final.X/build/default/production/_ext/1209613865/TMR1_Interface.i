...
# 2 "<built-in>" 2
# 1 "../MCAL/TMR1/TMR1_Interface.c" 2
# 1 "../MCAL/TMR1/TMR1_Interface.h" 1


# 1 "../MCAL/TMR1/../../SERVICES/STD_TYPES.h" 1
...
# 4 "../MCAL/TMR1/TMR1_Interface.h" 2
# 1 "../MCAL/TMR1/../../SERVICES/BIT_MATH.h" 1
# 5 "../MCAL/TMR1/TMR1_Interface.h" 2
# 1 "../MCAL/TMR1/TMR1_config.h" 1
# 6 "../MCAL/TMR1/TMR1_Interface.h" 2
# 1 "../MCAL/TMR1/TMR1_private.h" 1
# 7 "../MCAL/TMR1/TMR1_Interface.h" 2
...
# 2 "../MCAL/TMR1/TMR1_Interface.c" 2
# 1 "../MCAL/TMR1/../../SERVICES/config.h" 1
...
# 7 "../MCAL/TMR1/../../SERVICES/config.h" 2
# 3 "../MCAL/TMR1/TMR1_Interface.c" 2
...
void TMR1_SetPrescaler(u8 prescaler)
{
    ...
    switch (prescaler)
    {
        case 2: ((T1CON) |= (1U << (4))); break;
        case 4: ((T1CON) |= (1U << (5))); break;
        case 8: ((T1CON) |= (1U << (4)));
                 ((T1CON) |= (1U << (5))); break;
        default: break;
    }
