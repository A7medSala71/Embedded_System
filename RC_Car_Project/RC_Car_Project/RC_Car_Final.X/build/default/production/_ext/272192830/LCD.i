...
# 1 "../HAL/LCD/../../MCAL/I2C/I2C_private.h" 1
# 4 "../HAL/LCD/../../MCAL/I2C/I2C_Interface.h" 2
# 1 "../HAL/LCD/../../MCAL/I2C/I2C_config.h" 1
# 5 "../HAL/LCD/../../MCAL/I2C/I2C_Interface.h" 2

# 1 "../HAL/LCD/../../MCAL/I2C/../../SERVICES/BIT_MATH.h" 1
# 7 "../HAL/LCD/../../MCAL/I2C/I2C_Interface.h" 2
...
# 7 "../HAL/LCD/../../SERVICES/config.h" 2
# 4 "../HAL/LCD/LCD.c" 2


static u8 lcd_backlight = (1 << 3);
# 26 "../HAL/LCD/LCD.c"
static void LCD_Send_Nibble(u8 nibble, u8 rs) {
    u8 byte_val = lcd_backlight;
    if (rs) byte_val |= (1 << 0);

    if (nibble & 0x01) byte_val |= (1 << 4);
    if (nibble & 0x02) byte_val |= (1 << 5);
    if (nibble & 0x04) byte_val |= (1 << 6);
    if (nibble & 0x08) byte_val |= (1 << 7);

    do { do { I2C_Master_Start(); I2C_Master_Write(0x27 << 1); I2C_Master_Write((byte_val) | (1 << 2)); I2C_Master_Stop(); } while(0); _delay((unsigned long)((2)*(20000000UL/4000000.0))); do { I2C_Master_Start(); I2C_Master_Write(0x27 << 1); I2C_Master_Write((byte_val) & ~(1 << 2)); I2C_Master_Stop(); } while(0); _delay((unsigned long)((50)*(20000000UL/4000000.0))); } while(0);
}
...
void LCD_SetCursor(u8 row, u8 col) {
    u8 addr = (row == 0) ? (0x00 + col) : (0x40 + col);
...
void LCD_SetBacklight(u8 state) {
    lcd_backlight = state ? (1 << 3) : 0;
    do { I2C_Master_Start(); I2C_Master_Write(0x27 << 1); I2C_Master_Write(lcd_backlight); I2C_Master_Stop(); } while(0);
}
